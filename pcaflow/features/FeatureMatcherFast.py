...
class FeatureMatcherFast:
    def __init__(self,params):
        """
        Create new structure to extract and match FAST features,
        using the BRIEF descriptor.
        ...
        self.fast_detector = cv2.FastFeatureDetector_create(20)
